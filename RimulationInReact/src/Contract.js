...
if (windowObject.ethereum) {
  const contractAddress = "0xDE79Bc79780a62153685136aD05966C57D6B4753";
  ...
  web.on("CustomMint", (buyer, tokenId, time) => {
    ...
    console.log(buyer, tokenId.toString(), time.toString());

    axios.post("http://localhost:5001/mint", { data });
    console.log(buyer);

    //this section is called every time an event is emitted
  });
  web.on("UserInfo", (buyer, _x, _y, _z, _longitude, _latitude) => {
    let UserData = Object();
    UserData.buyer = buyer;
    UserData.x = _x;
    UserData.y = _y;
    UserData.z = _z;
    UserData.longitude = _longitude;
    UserData.latitude = _latitude;
    axios.post("http://localhost:5001/UserInfo", { UserData });
  });
}
